 ...
 *		  source file
 *
 * modified by Thomas E. Dickey 1995/11/19 to correct declarations
 *		of the b* functions
 */
/*
 * $Id: malloc.h.org,v 1.41 2003/12/24 14:42:39 tom Exp $
 */
...
#ifndef   DATATYPE
	/*
	 * the following string should cause a compilation error and get the
...
#define M_CODE_BAD_CONNECT	5	/* chain pointers corrupt	*/
...
#define M_CODE_OUTOF_BOUNDS	10	/* gone beyond bounds 		*/
#define M_CODE_FREELIST_BAD	11	/* inuse segment on freelist	*/
#define M_CODE_NOBOUND		12	/* can't calculate boundary	*/
...
/*
 * $Log: malloc.h.org,v $
 * Revision 1.41  2003/12/24 14:42:39  tom
 ...
 *
 * Revision 1.40  1995/11/19 22:13:40  tom
